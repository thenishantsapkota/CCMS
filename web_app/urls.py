...
urlpatterns = [
    path("create/", login_required(CertificateView.as_view(), login_url="/login"), name="create"),
    path("search/", login_required(CertificateSearchView.as_view(), login_url="/login"), name="search"),
